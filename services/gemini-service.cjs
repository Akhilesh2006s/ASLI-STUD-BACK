...
class GeminiService {
  ...
  async generateResponse(message, context = {}, chatHistory = []) {
    try {
      ...
      let systemInstruction = `You are Vidya AI for Asli Learn, an educational platform. You help students with their studies across various subjects including Physics, Chemistry, Mathematics, and Biology.
